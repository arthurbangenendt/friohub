...
-- Verificado só DEPOIS de cadastrar skills/raio: os dois disparam
-- `trg_skills_revalidacao`/`trg_areas_revalidacao`, que rebaixam de volta pra
-- 'em_analise' quando o dado relacionado muda depois da aprovação (ver
-- 20260813160000_partner_trust_and_admin_audit.sql).
