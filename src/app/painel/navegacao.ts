...
export const NAV_POR_PAPEL: Record<Papel, ItemNav[]> = {
  ...
  profissional: [
    ...
    { href: "/painel/assistente", label: "Assistente IA", icone: "assistente", feature: "assistente_ia" },
    { href: "/planos", label: "Planos", icone: "planos" },
    { href: "/painel/notificacoes", label: "Notificações", icone: "notificacoes" },
  ...
  distribuidora: [
    ...
    { href: "/painel/distribuidora/financeiro", label: "Financeiro", icone: "financeiro" },
    { href: "/painel/notificacoes", label: "Notificações", icone: "notificacoes" },
