...
import { Bolt, Wrench, User, Shield, Star, Tool, Droplet } from "@/components/icons";

export type ItemNav = { href: string; label: string; icone: keyof typeof ICONE };

const ICONE = {
  visao: Bolt, servicos: Wrench, financeiro: Droplet,
  avaliacoes: Star, ferramentas: Tool, perfil: User, admin: Shield,
};
...
export function PainelNav({ itens }: { itens: ItemNav[] }) {
